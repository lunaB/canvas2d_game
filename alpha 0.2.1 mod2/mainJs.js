...
function drow(){
    ...
    if(denger[dengerIndex].drowAble == true){ // 경고
        ...
        ctx.fillStyle = "rgba(0,0,255,"+ denger[dengerIndex].alpha +")";
	...
	if(denger[dengerIndex].attackAble == true){ // 발사
        ctx.fillStyle = denger[dengerIndex].Color;
